...
IMPORTANTE: Laravel requiere un archivo .env para funcionar. Si acabas de clonar el proyecto, este archivo no existe. Debes crearlo antes de generar la clave de la aplicación.
